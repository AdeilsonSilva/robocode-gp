...
public class MetaBot {
    ...
    // Static Variables //////////////////////////////////////////////////////
    final static String PATH = "/home/adeilson/robocode/robots/sampleex";
    String PACKAGE = "sampleex";
    String JARS = "/home/adeilson/robocode/libs/robocode.jar";

    final static int NUM_CHROMOS = 5,
            MIN_DEPTH = RunGP.MIN_DEPTH,
            MAX_DEPTH = RunGP.MAX_DEPTH;

    final static double PROB_CROSS_ROOT = 0.3,
    ...
    public int countNodes() {
        this.nodeCount = 0;
        for (ExpressionNode genome1 : genome) {
            nodeCount += genome1.countNodes();
        }
        return nodeCount;
    }
    ...
    // Genetic Methods ////////////////////////////////////////////////////////////////////////
    public MetaBot crossover(MetaBot p2, int gen, int botID) throws CloneNotSupportedException {
        ...
        while (xChromo2 == xChromo1) {
            xChromo2 = random.nextInt(NUM_CHROMOS);
        }
    ...
    public MetaBot mutate(int gen, int botID) throws CloneNotSupportedException {
        MetaBot child = new MetaBot(gen, botID);
